  ...
  return (
    <>
      <div className="w-full h-screen flex flex-wrap justify-center">
        <div
          className="w-1/2 bg-orange-600 flex bg-cover bg-no-repeat object-cover items-center justify-center"
          style={{
            backgroundImage: `url("https://images.pexels.com/photos/730547/pexels-photo-730547.jpeg?auto=compress&cs=tinysrgb&w=600")`,
          }}
        >
          <h1 className="flex items-center text-center text-8xl text-gray font-bold shadow-2xl ">
            Currency Convertor
          </h1>
        </div>
                ...
                >
                  <div className="w-full mb-1">
                    <InputBox
                      ...
                      onCurrenyChange={(currenvy) => setAmount(amount)}
                      selectCurrency={from}
                  ...
                  <div className="w-full mt-1 mb-4">
                    <InputBox
                      ...
                      currencyOptions={options}
                      onCurrenyChange={(curreny) => setTo(curreny)}
                      selectCurrency={to}
                      amountDisable={true}
                    />
                  </div>
